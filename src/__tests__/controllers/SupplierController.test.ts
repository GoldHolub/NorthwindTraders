...
describe('SupplierController', () => {
    ...
    describe('getSupplierById', () => {
        it('should return supplier when supplier exists', async () => {
            ...
            (SupplierService.prototype.getSupplierById as jest.Mock).mockResolvedValue(mockSupplier);
    ...
    describe('searchSuppliers', () => {
        it('should return suppliers and total count', async () => {
            ...
            expect(SupplierService.prototype.searchSuppliers).toHaveBeenCalledWith(
                1, // page
                10, // pageSize
        ...
        it('should return 500 when there is an error', async () => {
            (SupplierService.prototype.searchSuppliers as jest.Mock).mockRejectedValue(new Error('Database error'));
