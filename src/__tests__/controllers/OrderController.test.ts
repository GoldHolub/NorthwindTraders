...
describe('OrderController', () => {
    ...
    describe('searchOrders', () => {
        it('should return orders and total count', async () => {
            ...
            expect(OrderService.prototype.searchOrders).toHaveBeenCalledWith(
                1, // page
                10, // pageSize
        ...
        it('should return 500 when there is an error', async () => {
            (OrderService.prototype.searchOrders as jest.Mock).mockRejectedValue(new Error('Database error'));
