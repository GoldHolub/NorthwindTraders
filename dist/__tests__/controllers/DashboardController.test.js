...
describe('DashboardController', () => {
    ...
    describe('getLocation', () => {
        it('should return location when IP address is valid', async () => {
            ...
            IpLocationService.prototype.findLocationByIp.mockResolvedValue(mockLocation);
        ...
        it('should return 400 when IP address is invalid', async () => {
            IpLocationService.prototype.findLocationByIp
