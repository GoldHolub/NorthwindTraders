...
export class OrderRepository {
    async findOrderByIdAndLog(id: number, currentSession: SessionData) {
        try {
    ...
    async searchOrdersAndLog(page: number, pageSize: number, currentSession: SessionData) {
        try {
            ...
            const ordersList = orders as unknown as OrderType[];
    ...
    async createManyOrders(orders: any[]) {
        try {
    ...
    async createManyOrderDetails(details: any[]) {
        try {
    ...
    async createManyShippers(shippers: any[]) {
        try {
