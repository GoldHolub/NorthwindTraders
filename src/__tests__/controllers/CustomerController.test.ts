...
describe('CustomerController', () => {
    ...
    describe('getCustomerById', () => {
        it('should return customer when customer exists', async () => {
            ...
            (CustomerService.prototype.getCustomerById as jest.Mock).mockResolvedValue(mockCustomer);
    ...
    describe('searchCustomers', () => {
        it('should return customers and total count', async () => {
            ...
            expect(CustomerService.prototype.searchCustomers).toHaveBeenCalledWith(
    ...
    it('should return 500 when there is an error', async () => {
        (CustomerService.prototype.searchCustomers as jest.Mock).mockRejectedValue(new Error('Database error'));
