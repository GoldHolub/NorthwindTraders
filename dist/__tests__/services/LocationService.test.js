...
describe('IpLocationService', () => {
    ...
    describe('findLocationByIp', () => {
        ...
        test('should return error message when ipRepository throws an error', async () => {
            ...
            await expect(ipLocationService.findLocationByIp(ipAddress)).rejects.toThrow(new Error('Error fetching data from database'));
        });
    });
});
//# sourceMappingURL=LocationService.test.js.map